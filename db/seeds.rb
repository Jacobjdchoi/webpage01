...
# Products
  # Mooog
    ...
    @moogActuator.products.create(name: 'Industrial', url: 'http://www.moog.com/products/actuators-servoactuators/actuation-technologies.html')
    # Rotary Joint
    @moogRotaryJoint.products.create(name: 'Sing Channel', url: 'http://www.moog.com/products/fiber-optic-devices/fiber-optic-rotary-joints/single-channel-forj.html')
    @moogRotaryJoint.products.create(name: 'Multi-Channel', url: 'http://www.moog.com/products/fiber-optic-devices/fiber-optic-rotary-joints/multi-channel-forj.html')
    @moogRotaryJoint.products.create(name: 'Hybrid', url: 'http://www.moog.com/products/fiber-optic-devices/fiber-optic-rotary-joints/hybrid-forj.html')
    @moogRotaryJoint.products.create(name: 'Complete Rotary Interfaces', url: 'http://www.moog.com/products/fiber-optic-devices/fiber-optic-rotary-joints/complete-rotary-interfaces.html')
    # Other
    @moogOther.products.create(name: 'test', url: 'http://www.google.com')
  # Axon'
    # Composite
