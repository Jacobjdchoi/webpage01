...
# Brands (1-5)
Brand.create(id: 1, name: 'MOOG', summary_en: 'change this', summary_ko: '수정 하십시오')
Brand.create(id: 2, name: 'Axon', summary_en: 'change this', summary_ko: '수정 하십시오')
Brand.create(id: 3, name: 'AirBorn', summary_en: 'change this', summary_ko: '수정 하십시오')
Brand.create(id: 4, name: 'ODU', summary_en: 'change this', summary_ko: '수정 하십시오')
Brand.create(id: 5, name: 'STOCKO', summary_en: 'change this', summary_ko: '수정 하십시오')
# Moog (1-5)
