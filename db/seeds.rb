...
@adels = Brand.create(id: 5, name: 'Adels-Contact', background_pic: File.open(File.join(Rails.root, 'public/suppliers_banner/adels-contact.jpg')), photos_attributes: [{pics:File.open(File.join(Rails.root, 'public/suppliers_logo/adels-contact.jpg'))}])
