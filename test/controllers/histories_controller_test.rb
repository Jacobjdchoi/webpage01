...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { event_date: @history.event_date, title: @history.title } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { event_date: @history.event_date, title: @history.title } }
